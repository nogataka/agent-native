...
{
  "tone": "success",
  "body": "**Seguro para ativar, seguro para reverter.** As gravações de identidade são **apenas aditivas** — uma conta de mesmo e-mail existente é reutilizada sem alterações, e um novo e-mail apenas insere uma nova linha. Não há alteração de esquema e nada para migrar, portanto, ativar ou desativar `AGENT_NATIVE_IDENTITY_HUB_URL` é totalmente reversível a qualquer momento, por aplicativo."
}
```
...
{
  "html": "<div class=\"diagram-jit\"><div class=\"diagram-node\" data-rough>E-mail verificado<br><small class=\"diagram-muted\">de JWT de identidade assinado</small></div><div class=\"diagram-arrow diagram-muted\" aria-hidden=\"true\">&rarr;</div><div class=\"diagram-branch\"><div class=\"diagram-box\" data-rough>Local user exists?<span class=\"diagram-pill ok\">yes &rarr; reuse unchanged</span><span class=\"diagram-pill accent\">no &rarr; create local user</span></div><div class=\"diagram-arrow diagram-muted\" aria-hidden=\"true\">&rarr;</div><div class=\"diagram-box\" data-rough>Emitir sessão local normal</div></div></div>",

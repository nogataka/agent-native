...
{
  "html": "<div class=\"diagram-sso\"><div class=\"diagram-card\" data-rough><strong>تطبيق العميل</strong><small class=\"diagram-muted\">own user store</small></div><div class=\"diagram-step\"><div class=\"diagram-arrow diagram-muted\" aria-hidden=\"true\">&rarr;</div><span class=\"diagram-pill\">authorize</span></div><div class=\"diagram-card\" data-rough><strong>Dispatch</strong><small class=\"diagram-muted\">identity authority</small><span class=\"diagram-pill accent\">authenticates human</span></div><div class=\"diagram-step\"><div class=\"diagram-arrow diagram-muted\" aria-hidden=\"true\">&rarr;</div><span class=\"diagram-pill accent\">302 + signed JWT</span></div><div class=\"diagram-card\" data-rough><strong>استدعاء التطبيق</strong><small class=\"diagram-muted\">verify signature · scope:identity · exp &le; 2 min</small><span class=\"diagram-pill ok\">ربط فوري عبر البريد</span><span class=\"diagram-pill ok\">mint local session</span></div></div>",
...
{
  "tone": "success",
  "body": "**آمن للتمكين، وآمن للرجوع.** تعد عمليات كتابة الهوية **إضافية فقط** — تتم إعادة استخدام حساب البريد الإلكتروني الحالي دون تغيير، ويقوم البريد الإلكتروني الجديد فقط بإدراج صف جديد. لا يوجد أي تغيير في المخطط ولا يوجد أي شيء لترحيله، لذا فإن تشغيل `AGENT_NATIVE_IDENTITY_HUB_URL` أو إيقاف تشغيله يمكن عكسه بالكامل في أي وقت لكل تطبيق."
}
```

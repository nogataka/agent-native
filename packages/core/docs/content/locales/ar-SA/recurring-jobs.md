...
```an-annotated-code title="jobs/morning-digest.md"
{
  ...
  "language": "markdown",
  "code": "---\nschedule: \"0 7 * * *\"\nenabled: true\nrunAs: creator\n---\n\n# الملخص الصباحي\n\nتلخيص رسائل البريد الإلكتروني المستلمة خلال الليل. التجميع حسب مجال المرسل.\nقم بتثبيت أهم 3 سلاسل رسائل تبدو وكأنها تحتاج إلى رد اليوم في التصنيف\n\"يلزم الرد\". مسودة ردود على أي ردود واضحة.",
  "annotations": [
    { "lines": "2", "label": "متى", "note": "كرون قياسي ذو 5 حقول — `0 7 * * *` كل يوم في الساعة 07:00." },
    { "lines": "3", "label": "مفتاح الإيقاف المؤقت", "note": "Flip to `false` to stop the job without deleting it." },
    { "lines": "4", "label": "الهوية", "note": "`creator` runs with the owner's identity and `ANTHROPIC_API_KEY`; `shared` uses the org's key." },
    { "lines": "7-12", "label": "الموجه", "note": "النص هو مجرد موجه — يقوم الوكيل بتشغيله عند كل إطلاق بكل أدواته العادية وسياق مساحة العمل." }
  ]
}
```

...
{
  "html": "<div class=\"diagram-mode\"><div class=\"diagram-col entry\"><div class=\"diagram-node\">واجهة المحتوى</div><div class=\"diagram-node\">الوكيل + الإجراءات<br><small class=\"diagram-muted\">list/get/update-document</small></div></div><div class=\"diagram-arrow diagram-muted\" aria-hidden=\"true\">&rarr;</div><div class=\"diagram-row resolve\"><div class=\"diagram-panel\" data-rough><span class=\"diagram-pill accent\">وضع قاعدة البيانات</span><small class=\"diagram-muted\">SQL rows via Drizzle</small><small class=\"diagram-muted\">مستضاف · مشاركة · تعليقات · سجل</small></div><div class=\"diagram-panel\" data-rough><span class=\"diagram-pill ok\">Local File Mode</span><small class=\"diagram-muted\">repo files via agent-native.json</small><small class=\"diagram-muted\">مراجعة Git · تعديلات وكيل الترميز</small></div></div></div>",

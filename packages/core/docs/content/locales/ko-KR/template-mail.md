...
{
  "surface": "desktop",
  "html": "<div style='display:flex;flex-direction:column;min-height:500px;box-sizing:border-box'><div style='display:flex;align-items:center;gap:12px;padding:12px 16px;border-bottom:1.4px solid var(--wf-line)'><strong>받은편지함 16</strong><div style='flex:1'></div><span data-icon='search' aria-label='검색'></span><span data-icon='edit' aria-label='작성'></span><span data-icon='bell' aria-label='알림'></span></div><div style='display:flex;flex-direction:column;padding:8px 14px;gap:6px'><div class='wf-box' style='display:grid;grid-template-columns:155px 1fr auto;gap:12px;align-items:center'><strong>프리야 민</strong><span><strong>3분기 출시</strong> — 최종 에셋 검토 준비 완료</span><span>★</span></div><div class='wf-box' style='display:grid;grid-template-columns:155px 1fr auto;gap:12px;align-items:center'><strong>Acme 청구</strong><span>월간 인보이스가 준비되었습니다</span><span>11:10 AM</span></div><div class='wf-box' style='display:grid;grid-template-columns:155px 1fr auto;gap:12px;align-items:center'><span>민수 탕</span><span>온보딩 흐름 research findings</span><span>어제</span></div><div class='wf-box' style='display:grid;grid-template-columns:155px 1fr auto;gap:12px;align-items:center'><span>GitHub</span><span>[framework] PR 리뷰 준비 완료</span><span>어제</span></div><div class='wf-box' style='display:grid;grid-template-columns:155px 1fr auto;gap:12px;align-items:center'><span>Linear</span><span>Issue ENG-1287이 배정되었습니다</span><span>5월 2일</span></div><div class='wf-box' style='display:grid;grid-template-columns:155px 1fr auto;gap:12px;align-items:center'><span>Stripe</span><span>주간 결제 요약</span><span>4월 29일</span></div><div class='wf-box' style='display:grid;grid-template-columns:155px 1fr auto;gap:12px;align-items:center'><span>Calendly</span><span>새 예약 확인됨</span><span>4월 28일</span></div></div></div>"
}
```
...
```an-schema title="메일 SQL 테이블" summary="이메일 자체는 Gmail에 있습니다. SQL 테이블에는 Gmail에 없는 내용(대기 중인 초안, 전송 추적 이벤트, OAuth 토큰)이 들어 있습니다. 설정 및 임시 상태는 settings 및 application_state 저장소에 있습니다."
{
  "entities": [
    {
      "id": "queued_email_drafts",
      "name": "queued_email_drafts",
      "note": "소유자 검토를 기다리는 초안 Teammate/Slack-requested개",
      "fields": [
    ...
    },
    {
      "id": "oauth_tokens",
      "name": "oauth_tokens",
      "note": "프레임워크 테이블 — 연결된 Google 계정당 행 1개",
      "fields": [
        { "name": "id", "type": "id", "pk": true },

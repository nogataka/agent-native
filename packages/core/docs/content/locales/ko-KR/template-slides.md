...
```an-schema title="슬라이드 데이터 모델" summary="A deck owns its slides as JSON in decks.data; comments, versions, shares, and design systems hang off it."
{
  "entities": [
    {
      "id": "decks",
    ...
    },
    {
      ...
      "fields": [
        ...
        { "name": "slide_id", "type": "text", "note": "댓글이 계속 유지되도록 슬라이드하세요." },
        { "name": "thread_id", "type": "text", "note": "스레딩" },
    ...
    },
    {
      ...
      "fields": [
        { "name": "deck_id", "type": "text", "fk": "decks.id" },
        { "name": "title", "type": "text" },
        { "name": "data", "type": "text", "note": "전체 데크 JSON" },
    ...
    },
    {
      ...
      "fields": [
        ...
        { "name": "title", "type": "text" },
        { "name": "slides", "type": "text", "note": "JSON 슬라이드 스냅샷" },

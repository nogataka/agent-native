...
{
  "html": "<div class=\"diagram-flow\"><div class=\"diagram-card\"><span class=\"diagram-pill\">Sources</span><small class=\"diagram-muted\">Slack · Granola · GitHub · Clips · webhooks</small></div><div class=\"diagram-arrow diagram-muted\" aria-hidden=\"true\">&rarr;</div><div class=\"diagram-box\" data-rough>원시 캡처<br><small class=\"diagram-muted\">중복 제거됨, 수정됨</small></div><div class=\"diagram-arrow diagram-muted\" aria-hidden=\"true\">&rarr;</div><div class=\"diagram-box\" data-rough>Distill<br><small class=\"diagram-muted\">사실 · 결정 · 프로세스</small></div><div class=\"diagram-arrow diagram-muted\" aria-hidden=\"true\">&rarr;</div><div class=\"diagram-card\"><span class=\"diagram-pill warn\">Review</span><small class=\"diagram-muted\">sensitive / low-confidence queue</small></div><div class=\"diagram-arrow diagram-muted\" aria-hidden=\"true\">&rarr;</div><div class=\"diagram-box\" data-rough><span class=\"diagram-pill ok\">Knowledge</span><small class=\"diagram-muted\">승인됨, 원자적</small></div><div class=\"diagram-arrow diagram-muted\" aria-hidden=\"true\">&rarr;</div><div class=\"diagram-panel center\"><span class=\"diagram-pill accent\">Ask</span><small class=\"diagram-muted\">cited answer</small></div></div>",
...
{
  "surface": "desktop",
  "html": "<div style='display:flex;flex-direction:column;gap:14px;padding:18px;min-height:520px;box-sizing:border-box'><div style='display:flex;align-items:center;gap:10px'><h1 style='margin:0'>회사 메모리에 질문</h1><span class='wf-pill accent'>42 approved memories</span><span class='wf-pill'>3 sources</span><div style='flex:1'></div><button>Sources</button><button>Review</button></div><div class='wf-card' style='display:flex;align-items:center;gap:10px'><span data-icon='search' aria-label='검색'></span><strong style='flex:1'>왜 사용량 기반 가격을 선택했나요?</strong><button class='primary'>Ask</button></div><div class='wf-card' style='display:flex;flex-direction:column;gap:10px'><strong>Answer</strong><p style='margin:0'>파일럿에서 좌석 수가 자동화 가치를 과소평가한다는 점이 드러난 뒤 팀은 사용량 기반 가격을 선택했습니다.</p><div style='display:flex;gap:8px;flex-wrap:wrap'><span class='wf-pill accent'>가격 책정 RFC</span><span class='wf-pill'>출시 회고</span><span class='wf-pill'>영업 메모</span></div></div><div class='wf-card' style='flex:1;display:flex;flex-direction:column;gap:8px'><strong>소스 타임라인</strong><div class='wf-box'>5월 3일 · 결정 기록됨</div><div class='wf-box'>5월 8일 · 고객 증거 추가됨</div><div class='wf-box'>5월 12일 · 법무 메모 승인됨</div></div></div>"
}
```
...
```an-schema title="뇌 데이터 모델" summary="Connectors produce raw captures; distillation turns captures into reviewable knowledge; proposals gate sensitive entries. Sync runs and the ingest queue track background work."
{
  "entities": [
    { "id": "sources", "name": "brain_sources", "note": "커넥터 구성", "fields": [
    ...
    { "id": "captures", "name": "brain_raw_captures", "note": "수집된 원시 페이로드", "fields": [
      { "name": "id", "type": "id", "pk": true },
      { "name": "source_id", "type": "id", "fk": "brain_sources.id" },
    ...
    { "id": "knowledge", "name": "brain_knowledge", "note": "증류된 원자 항목", "fields": [
      { "name": "id", "type": "id", "pk": true },
    ...
    { "id": "proposals", "name": "brain_proposals", "note": "검토 항목 대기 중", "fields": [
      { "name": "id", "type": "id", "pk": true },
    ...
    { "id": "sync_runs", "name": "brain_sync_runs", "note": "동기화 감사 로그", "fields": [
      { "name": "source_id", "type": "id", "fk": "brain_sources.id" },
      { "name": "status", "type": "text" },
      { "name": "stats", "type": "json" }
    ] },
    { "id": "ingest_queue", "name": "brain_ingest_queue", "note": "백그라운드 증류 대기열", "fields": [
...
```an-api title="서명된 수집 웹훅" summary="클립 및 일반 transcript/capture 가져오기는 소스별 전달자 토큰과 함께 RawCapturePayload을 게시합니다."
{
  "method": "POST",
  "path": "/api/_agent-native/brain/ingest",
  "summary": "Clips 또는 일반 소스에서 원시 캡처 가져오기",

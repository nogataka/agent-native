...
- 개별 이메일 승인을 위한 Google 문서 스타일 `알림 people` 확인란.
...
```an-schema title="리소스 + 컴패니언 공유 테이블" summary="Coarse visibility lives on the resource; each fine-grained grant is a row in the shares table."
{
  "entities": [
    {
      "id": "deck",
      ...
      "fields": [
        ...
        { "name": "owner_email", "type": "text", "nullable": false, "note": "소유권에 대한 단일 정보 소스입니다." },
        { "name": "org_id", "type": "text", "nullable": true },
        { "name": "visibility", "type": "enum", "nullable": false, "note": "비공개 | 조직 | 공공의" }
      ]
    },
    {
      "id": "deckShare",
      ...
      "fields": [
        ...
        { "name": "principal_type", "type": "enum", "note": "사용자 | 조직" },

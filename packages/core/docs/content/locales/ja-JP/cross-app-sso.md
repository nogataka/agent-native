...
{
  "html": "<div class=\"diagram-sso\"><div class=\"diagram-card\" data-rough><strong>クライアントアプリ</strong><small class=\"diagram-muted\">own user store</small></div><div class=\"diagram-step\"><div class=\"diagram-arrow diagram-muted\" aria-hidden=\"true\">&rarr;</div><span class=\"diagram-pill\">authorize</span></div><div class=\"diagram-card\" data-rough><strong>Dispatch</strong><small class=\"diagram-muted\">identity authority</small><span class=\"diagram-pill accent\">authenticates human</span></div><div class=\"diagram-step\"><div class=\"diagram-arrow diagram-muted\" aria-hidden=\"true\">&rarr;</div><span class=\"diagram-pill accent\">302 + signed JWT</span></div><div class=\"diagram-card\" data-rough><strong>アプリのコールバック</strong><small class=\"diagram-muted\">verify signature · scope:identity · exp &le; 2 min</small><span class=\"diagram-pill ok\">メールによる JIT リンク</span><span class=\"diagram-pill ok\">mint local session</span></div></div>",
...
{
  "tone": "success",
  "body": "**有効にしても安全、元に戻しても安全です。**ID の書き込みは**追加のみ**です。既存の同じ電子メール アカウントはそのまま再利用され、新しい電子メールは新しい行を挿入するだけです。スキーマの変更や移行するものはないため、アプリごとに `AGENT_NATIVE_IDENTITY_HUB_URL` のオンとオフをいつでも完全に元に戻すことができます。"
}
```

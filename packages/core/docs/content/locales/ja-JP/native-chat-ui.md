...
{
  "html": "<div class=\"diagram-render\"><div class=\"diagram-node\">Actionが実行<br><small class=\"diagram-muted\">構造化JSONを返す</small></div><div class=\"diagram-arrow diagram-muted\" aria-hidden=\"true\">&rarr;</div><div class=\"diagram-panel center\" data-rough><span class=\"diagram-pill accent\">Match</span><small class=\"diagram-muted\">explicit widget &middot; chatUI.renderer</small></div><div class=\"diagram-arrow diagram-muted\" aria-hidden=\"true\">&rarr;</div><div class=\"diagram-box\">&lt;AssistantChat&gt;<br><small class=\"diagram-muted\">Reactウィジェットをマウント</small></div><div class=\"diagram-arrow diagram-muted\" aria-hidden=\"true\">&rarr;</div><div class=\"diagram-card col\"><div class=\"diagram-pill ok\">DataTable</div><div class=\"diagram-pill ok\">DataChart</div><div class=\"diagram-pill ok\">DataInsights</div></div></div>",
...
{
  "tone": "success",
  "body": "レンダラーは、アクションが `chatUI`**または**結果に明示的な既知の `widget` 判別式が含まれていると宣言した場合にのみ引き継ぎます。任意のオブジェクトを形状推論したり、ツールの結果から HTML や JavaScript を実行したりすることはありません。そのため、ネイティブ ウィジェットがインジェクション ベクトルになることはありません。"
}
```
...
{
  "html": "<div class=\"diagram-byo\"><div class=\"diagram-box\" data-rough>あなたのエージェント<br><small class=\"diagram-muted\">OpenAI &middot; Claude &middot; Vercel AI &middot; AG-UI &middot; HTTP</small></div><div class=\"diagram-arrow diagram-muted\" aria-hidden=\"true\">&rarr;</div><div class=\"diagram-panel center\"><span class=\"diagram-pill accent\">connector</span><small class=\"diagram-muted\">正規化されたmessage-* / tool-*イベント</small></div><div class=\"diagram-arrow diagram-muted\" aria-hidden=\"true\">&rarr;</div><div class=\"diagram-card col\"><div class=\"diagram-pill\">&lt;AssistantChat runtime=&hellip; /&gt;</div><small class=\"diagram-muted\">composer &middot; transcript &middot; tool cards</small><small class=\"diagram-muted\">approvals &middot; native widgets</small></div></div>",

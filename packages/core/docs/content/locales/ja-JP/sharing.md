...
- 個々の電子メール許可のための Google ドキュメント スタイルの `通知 people` チェックボックス。
...
```an-schema title="リソース + コンパニオン共有テーブル" summary="Coarse visibility lives on the resource; each fine-grained grant is a row in the shares table."
{
  "entities": [
    {
      "id": "deck",
      ...
      "fields": [
        ...
        { "name": "owner_email", "type": "text", "nullable": false, "note": "所有権に関する唯一の信頼できる情報源。" },
        { "name": "org_id", "type": "text", "nullable": true },
        { "name": "visibility", "type": "enum", "nullable": false, "note": "プライベート |組織 |公共" }
      ]
    },
    {
      "id": "deckShare",
      ...
      "fields": [
        ...
        { "name": "principal_type", "type": "enum", "note": "ユーザー |組織" },

...
>
> **अनुप्रयोग** - एजेंट के चारों ओर उत्पाद की सतह। यह पहली बार में केवल एक्शन, रिच चैट, एक छोटा नियंत्रण विमान, या डैशबोर्ड, प्रवाह और विज़ुअलाइज़ेशन के साथ एक पूर्ण React इंटरफेस हो सकता है।
>
...
{
  "html": "<div class=\"diagram-arch\"><div class=\"diagram-row\"><div class=\"diagram-card\"><span class=\"diagram-pill accent\">Agent</span><small class=\"diagram-muted\">डेटा पढ़ता और लिखता है, actions चलाता है, कोड बदलता है</small></div><div class=\"diagram-card\"><span class=\"diagram-pill\">Application</span><small class=\"diagram-muted\">सिर्फ action, chat, control plane, या full React इंटरफेस</small></div></div><div class=\"diagram-arrow diagram-muted\" aria-hidden=\"true\">&darr;&nbsp;&uarr;</div><div class=\"diagram-box\" data-rough>Computer<br><small class=\"diagram-muted\">SQL डेटाबेस · browser · code execution</small></div></div>",
...
```an-schema title="कोर SQL स्टोर" summary="प्रत्येक टेम्पलेट में स्वतः निर्मित - एजेंट और UI दोनों इन्हें पढ़ते और लिखते हैं।"
{
  "entities": [
    { "id": "application_state", "name": "application_state", "note": "अल्पकालिक UI बताता है कि एजेंट संदर्भ के लिए पढ़ता है", "fields": [
      { "name": "key", "type": "text", "pk": true, "note": "उदा. 'navigation'" },
      { "name": "value", "type": "json", "note": "दृश्य, चयन, ड्राफ्ट" }
    ] },
    { "id": "settings", "name": "settings", "note": "लगातार कुंजी-मूल्य कॉन्फ़िगरेशन", "fields": [
      { "name": "key", "type": "text", "pk": true },
      { "name": "value", "type": "json" }
    ] },
    { "id": "oauth_tokens", "name": "oauth_tokens", "note": "OAuth क्रेडेंशियल", "fields": [
      { "name": "provider", "type": "text", "pk": true },
      { "name": "token", "type": "text" }
    ] },
    { "id": "sessions", "name": "sessions", "note": "प्रामाणिक सत्र", "fields": [
...
```bash
# त्वरित डेटाबेस निरीक्षण और एकमुश्त रखरखाव के लिए मुख्य कार्रवाइयां
...
# बड़े टेक्स्ट कॉलम पर सर्जिकल find/replace - एक अंतर भेजता है, संपूर्ण मान नहीं
...
{
  "html": "<div class=\"diagram-sync\"><div class=\"diagram-node\">एजेंट action<br><small class=\"diagram-muted\">DB में लिखता है</small></div><div class=\"diagram-arrow diagram-muted\" aria-hidden=\"true\">&rarr;</div><div class=\"diagram-node\">बदलाव इवेंट<br><small class=\"diagram-muted\">source: action / settings</small></div><div class=\"diagram-arrow diagram-muted\" aria-hidden=\"true\">&rarr;</div><div class=\"diagram-panel center\"><span class=\"diagram-pill accent\">useDbSync</span><small class=\"diagram-muted\">SSE &middot; poll fallback</small></div><div class=\"diagram-arrow diagram-muted\" aria-hidden=\"true\">&rarr;</div><div class=\"diagram-node\">क्वेरी फिर से fetch<br><small class=\"diagram-muted\">रेंडर, रीलोड नहीं</small></div></div>",
...
- **BYO एजेंट चैट रनटाइम।** वही चैट UI OpenAI एजेंट, OpenAI प्रतिक्रियाएं, Claude एजेंट SDK, वर्सेल AI SDK, AG-UI, या आपकी अपनी सामान्यीकृत HTTP स्ट्रीम के शीर्ष पर बैठ सकती है। [Native चैट UI](/docs/native-chat-ui#byo-agent-runtimes) देखें.
...
- [Native चैट UI](/docs/native-chat-ui) - क्रिया-घोषित तालिकाएँ, चार्ट और BYO रनटाइम मुद्रा

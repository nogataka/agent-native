...
{
  "html": "<div class=\"diagram-stack\"><div class=\"diagram-card layer\"><span class=\"diagram-pill accent\">1 &middot; Yjs Y.Doc</span><small class=\"diagram-muted\">CRDT &mdash; conflict-free merge, कोई coordinator नहीं</small></div><div class=\"diagram-card layer\"><span class=\"diagram-pill\">2 &middot; SQL canonical content</span><small class=\"diagram-muted\">_collab_docs &mdash; durable source of truth, versioned</small></div><div class=\"diagram-card layer\"><span class=\"diagram-pill\">3 &middot; updatedAt-gated reconcile</span><small class=\"diagram-muted\">एजेंट edits SQL bump से propagate होते हैं</small></div><div class=\"diagram-card layer\"><span class=\"diagram-pill\">4 &middot; लीड-क्लाइंट चुनाव</span><small class=\"diagram-muted\">ठीक एक टैब snapshot लागू करता है</small></div><div class=\"diagram-card layer\"><span class=\"diagram-pill ok\">5 &middot; SSE fast-path + polling</span><small class=\"diagram-muted\">~दर्जनों ms, कहीं भी 2s polling तक degrade</small></div></div>",
...
{
  "html": "<div class=\"diagram-collab\"><div class=\"lane\"><span class=\"diagram-pill\">मानवीय संपादन</span><div class=\"diagram-node\">Y.Doc update<br><small class=\"diagram-muted\">debounce लगभग 80ms</small></div><span class=\"diagram-arrow diagram-muted\" aria-hidden=\"true\">&rarr;</span><div class=\"diagram-box\" data-rough>POST /update<br><small class=\"diagram-muted\">apply + persist</small></div><span class=\"diagram-arrow diagram-accent\" aria-hidden=\"true\">&rarr;</span><div class=\"diagram-box diagram-accent\">SSE push<br><small class=\"diagram-muted\">to all peers</small></div></div><div class=\"lane\"><span class=\"diagram-pill warn\">एजेंट संपादन</span><div class=\"diagram-node\">Action SQL लिखता है<br><small class=\"diagram-muted\">updatedAt अपडेट करता है</small></div><span class=\"diagram-arrow diagram-muted\" aria-hidden=\"true\">&rarr;</span><div class=\"diagram-box\" data-rough>लीड क्लाइंट<br><small class=\"diagram-muted\">setContent को Y.Doc में</small></div><span class=\"diagram-arrow diagram-accent\" aria-hidden=\"true\">&rarr;</span><div class=\"diagram-box diagram-accent\">POST /update<br><small class=\"diagram-muted\">re-enters Yjs &middot; SSE push</small></div></div></div>",
...
{
  "tone": "risk",
  "body": "**एक ही क्षेत्र में एक साथ पुनर्लेखन अंतिम-लेखन-जीत है।** यदि एजेंट किसी अनुच्छेद को फिर से लिखता है जबकि किसी मानव के पास *बिल्कुल उसी क्षेत्र* में सहेजे न गए संपादन हैं, तो लीड-क्लाइंट स्नैपशॉट इन-फ़्लाइट मानव संपादन को रोक सकता है। विभिन्न क्षेत्रों में संपादन हमेशा CRDT के माध्यम से साफ़-साफ़ मर्ज होते हैं। संरचित दस्तावेज़ों के लिए, इसे पूरी तरह से दूर करने के लिए ग्रैन्युलर सर्वर-साइड मर्ज का उपयोग करें।"
}
```

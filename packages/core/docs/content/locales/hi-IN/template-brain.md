...
{
  "html": "<div class=\"diagram-flow\"><div class=\"diagram-card\"><span class=\"diagram-pill\">Sources</span><small class=\"diagram-muted\">Slack · Granola · GitHub · Clips · webhooks</small></div><div class=\"diagram-arrow diagram-muted\" aria-hidden=\"true\">&rarr;</div><div class=\"diagram-box\" data-rough>कच्चे कैप्चर<br><small class=\"diagram-muted\">डुप्लिकेट हटाया, संपादित</small></div><div class=\"diagram-arrow diagram-muted\" aria-hidden=\"true\">&rarr;</div><div class=\"diagram-box\" data-rough>Distill<br><small class=\"diagram-muted\">तथ्य · निर्णय · प्रक्रियाएं</small></div><div class=\"diagram-arrow diagram-muted\" aria-hidden=\"true\">&rarr;</div><div class=\"diagram-card\"><span class=\"diagram-pill warn\">Review</span><small class=\"diagram-muted\">sensitive / low-confidence queue</small></div><div class=\"diagram-arrow diagram-muted\" aria-hidden=\"true\">&rarr;</div><div class=\"diagram-box\" data-rough><span class=\"diagram-pill ok\">Knowledge</span><small class=\"diagram-muted\">स्वीकृत, परमाणु</small></div><div class=\"diagram-arrow diagram-muted\" aria-hidden=\"true\">&rarr;</div><div class=\"diagram-panel center\"><span class=\"diagram-pill accent\">Ask</span><small class=\"diagram-muted\">cited answer</small></div></div>",
...
{
  "surface": "desktop",
  "html": "<div style='display:flex;flex-direction:column;gap:14px;padding:18px;min-height:520px;box-sizing:border-box'><div style='display:flex;align-items:center;gap:10px'><h1 style='margin:0'>company memory से पूछें</h1><span class='wf-pill accent'>42 approved memories</span><span class='wf-pill'>3 sources</span><div style='flex:1'></div><button>Sources</button><button>Review</button></div><div class='wf-card' style='display:flex;align-items:center;gap:10px'><span data-icon='search' aria-label='खोजें'></span><strong style='flex:1'>हमने usage pricing क्यों चुनी?</strong><button class='primary'>Ask</button></div><div class='wf-card' style='display:flex;flex-direction:column;gap:10px'><strong>Answer</strong><p style='margin:0'>pilots ने दिखाया कि seat counts automation value को कम आँकते हैं, इसलिए team ने usage pricing चुनी.</p><div style='display:flex;gap:8px;flex-wrap:wrap'><span class='wf-pill accent'>मूल्य निर्धारण RFC</span><span class='wf-pill'>लॉन्च retro</span><span class='wf-pill'>बिक्री नोट्स</span></div></div><div class='wf-card' style='flex:1;display:flex;flex-direction:column;gap:8px'><strong>स्रोत टाइमलाइन</strong><div class='wf-box'>3 मई · Decision captured</div><div class='wf-box'>8 मई · Customer evidence added</div><div class='wf-box'>12 मई · Legal note approved</div></div></div>"
}
```
...
```an-schema title="मस्तिष्क डेटा मॉडल" summary="Connectors produce raw captures; distillation turns captures into reviewable knowledge; proposals gate sensitive entries. Sync runs and the ingest queue track background work."
{
  "entities": [
    { "id": "sources", "name": "brain_sources", "note": "कनेक्टर कॉन्फ़िगरेशन", "fields": [
    ...
    { "id": "captures", "name": "brain_raw_captures", "note": "कच्चे पेलोड को निगला", "fields": [
      { "name": "id", "type": "id", "pk": true },
      { "name": "source_id", "type": "id", "fk": "brain_sources.id" },
    ...
    { "id": "knowledge", "name": "brain_knowledge", "note": "आसुत परमाणु प्रविष्टियाँ", "fields": [
      { "name": "id", "type": "id", "pk": true },
    ...
    { "id": "proposals", "name": "brain_proposals", "note": "लंबित समीक्षा आइटम", "fields": [
      { "name": "id", "type": "id", "pk": true },
    ...
    { "id": "sync_runs", "name": "brain_sync_runs", "note": "ऑडिट लॉग सिंक करें", "fields": [
      { "name": "source_id", "type": "id", "fk": "brain_sources.id" },
      { "name": "status", "type": "text" },
      { "name": "stats", "type": "json" }
    ] },
    { "id": "ingest_queue", "name": "brain_ingest_queue", "note": "पृष्ठभूमि आसवन कतार", "fields": [
...
```an-api title="हस्ताक्षरित इनजेस्ट वेबहुक" summary="क्लिप और सामान्य transcript/capture आयात प्रति-स्रोत वाहक टोकन के साथ एक रॉकैप्चरपेलोड पोस्ट करते हैं।"
{
  "method": "POST",
  "path": "/api/_agent-native/brain/ingest",
  "summary": "क्लिप्स या सामान्य स्रोत से एक कच्चा कैप्चर आयात करें",

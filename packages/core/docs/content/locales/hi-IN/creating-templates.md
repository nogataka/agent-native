...
रूट `app/routes/` में रहते हैं और React राउटर v8 फ़ाइल रूटिंग का उपयोग करते हैं। actions या API हैंडलर के माध्यम से डेटा क्वेरी करें, और म्यूटेशन को डिफ़ॉल्ट रूप से आशावादी बनाएं।

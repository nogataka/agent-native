...
```an-api title="Endpoint MCP" summary="El punto final Streamable HTTP montado automáticamente que expone cada aplicación nativa del agente."
{
  "method": "POST",
  "path": "/_agent-native/mcp",
  "summary": "MCP Punto final HTTP transmitible",

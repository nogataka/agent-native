...
```an-api title="MCP端点" summary="每个代理本机应用程序都会公开自动安装的 Streamable HTTP 端点。"
{
  "method": "POST",
  "path": "/_agent-native/mcp",
  "summary": "MCP 可流式 HTTP 端点",

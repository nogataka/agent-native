...
{
  "html": "<div class=\"diagram-layers\"><div class=\"diagram-row\"><div class=\"diagram-card\" data-rough><span class=\"diagram-pill\">CLI</span><small class=\"diagram-muted\">启动 · 恢复 · 状态 · 停止</small></div><div class=\"diagram-card\" data-rough><span class=\"diagram-pill\">Desktop</span><small class=\"diagram-muted\">原生终端 · webviews · 深链接</small></div><div class=\"diagram-card\" data-rough><span class=\"diagram-pill accent\">分享d UI</span><small class=\"diagram-muted\">@agent-native/code-agents-ui</small></div></div><div class=\"diagram-arrow diagram-muted\" aria-hidden=\"true\">&darr;</div><div class=\"diagram-panel center\" data-rough><span class=\"diagram-pill\">CodeAgentsHost</span><small class=\"diagram-muted\">host contract</small></div><div class=\"diagram-arrow diagram-muted\" aria-hidden=\"true\">&darr;</div><div class=\"diagram-box\" data-rough>文件支持的运行存储 + 执行器<br><small class=\"diagram-muted\">@agent-native/core/code-agents</small></div></div>",
...
{
  "html": "<div class=\"diagram-remote\"><div class=\"diagram-node\" data-rough>移动端 / Telegram<br><small class=\"diagram-muted\">/code · 会话</small></div><div class=\"diagram-arrow diagram-muted\" aria-hidden=\"true\">&rarr;</div><div class=\"diagram-box\" data-rough>Dispatch 中继<br><small class=\"diagram-muted\">主机 · 运行 · 转录</small></div><div class=\"diagram-arrow diagram-muted\" aria-hidden=\"true\">&larr;</div><div class=\"diagram-node\" data-rough>Desktop<br><small class=\"diagram-muted\">长轮询 · 领取 · 驱动运行存储</small></div></div>",
...
```an-api title="桌面声明排队的工作"
{
  "method": "POST",
  "path": "/_agent-native/integrations/remote/poll",
  "summary": "桌面长轮询中继以声明排队的命令",

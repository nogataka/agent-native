...
{
  "html": "<div class=\"diagram-sso\"><div class=\"diagram-card\" data-rough><strong>客户端应用</strong><small class=\"diagram-muted\">own user store</small></div><div class=\"diagram-step\"><div class=\"diagram-arrow diagram-muted\" aria-hidden=\"true\">&rarr;</div><span class=\"diagram-pill\">authorize</span></div><div class=\"diagram-card\" data-rough><strong>Dispatch</strong><small class=\"diagram-muted\">identity authority</small><span class=\"diagram-pill accent\">authenticates human</span></div><div class=\"diagram-step\"><div class=\"diagram-arrow diagram-muted\" aria-hidden=\"true\">&rarr;</div><span class=\"diagram-pill accent\">302 + signed JWT</span></div><div class=\"diagram-card\" data-rough><strong>应用回调</strong><small class=\"diagram-muted\">verify signature · scope:identity · exp &le; 2 min</small><span class=\"diagram-pill ok\">通过邮箱即时关联</span><span class=\"diagram-pill ok\">mint local session</span></div></div>",
...
{
  "tone": "success",
  "body": "**启用安全，恢复安全。**身份写入**仅可添加**- 现有的同一电子邮件帐户将不受影响地重复使用，而新电子邮件只需插入新行。没有架构更改，也没有任何需要迁移的内容，因此每个应用程序都可以随时完全可逆地打开或关闭 `AGENT_NATIVE_IDENTITY_HUB_URL`。"
}
```

...
```an-api title="Point de terminaison MCP" summary="Le point de terminaison Streamable HTTP monté automatiquement et exposé par chaque application native d'agent."
{
  "method": "POST",
  "path": "/_agent-native/mcp",
  "summary": "MCP Point de terminaison HTTP diffusable",

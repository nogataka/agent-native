const messages = {
  ...
  transcriptPanel: {
    ...
    cleanupPaused:
      "सफ़ाई रुकी हुई है. इसे सक्षम करने के लिए सेटिंग्स में Builder.io कनेक्ट करें।",
    builderNoResponse:
  ...
  recordRoute: {
    ...
    connectStorageToFinish:
      "Connect Builder.io or S3 storage on the next screen and Clips will finish saving it. (स्थानीयकृत)",
    connectStorageToRetryLoom:
      "Connect Builder.io or S3 storage on the next screen and Clips will retry the import. (स्थानीयकृत)",
  },
  dictateRoute: {

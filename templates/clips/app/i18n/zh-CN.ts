const messages = {
  ...
  recordingPage: {
    ...
    loomSourcePreserved:
      "Loom 源链接被保留。连接 Builder.io 或 S3 存储，Clips 将重试保存其自己的副本。",
    clipDataPreserved:
  ...
  sharePage: {
    ...
    loomPreservedManage:
      "Loom 源链接被保留。连接 Builder.io 或 S3 存储，然后重试导入。",
    videoPreservedManage:
      "视频被保留。连接Builder.io或S3存储，Clips将完成上传。",
    creatorNeedsStorage: "创建者需要连接 Builder.io 或 S3 存储才能完成此剪辑。",
    signInStorage:
      "如果这是您的剪辑，请在此处登录以连接 Builder.io 或 S3 存储并完成上传。",
  ...
  transcriptPanel: {
    ...
    cleanupPaused: "清理已暂停。在“设置”中连接 Builder.io 即可启用它。",
  ...
  stitchManager: {
    ...
    connectStorage: "拼接录制前请连接 Builder.io 或 S3 兼容存储。",
    created: "拼接录制已创建",
    failed: "拼接录制失败",
  ...
  recordRoute: {
    ...
    connectStorageToFinish:
      "Connect Builder.io or S3 storage on the next screen and Clips will finish saving it. (已本地化)",
    connectStorageToRetryLoom:
      "Connect Builder.io or S3 storage on the next screen and Clips will retry the import. (已本地化)",
  },
  dictateRoute: {

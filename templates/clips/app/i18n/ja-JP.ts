const messages = {
  ...
  transcriptPanel: {
    ...
    cleanupPaused:
      "クリーンアップは一時停止されています。設定でBuilder.ioを接続して有効にします。",
    builderNoResponse:
  ...
  stitchManager: {
    ...
    connectStorage:
      "録画を結合する前に Builder.io または S3 互換ストレージを接続してください。",
    created: "結合録画を作成しました",
    failed: "録画の結合に失敗しました",
  ...
  recordRoute: {
    ...
    connectStorageToFinish:
      "Connect Builder.io or S3 storage on the next screen and Clips will finish saving it. (ローカライズ済み)",
    connectStorageToRetryLoom:
      "Connect Builder.io or S3 storage on the next screen and Clips will retry the import. (ローカライズ済み)",
  },
  dictateRoute: {
